...
open class GenPagesOrderDetailsOrderDetails : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesOrderDetailsOrderDetails) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!;
            val _ctx = __ins.proxy as GenPagesOrderDetailsOrderDetails;
            ...
            val fetchOrderDetail = fun(orderId): UTSPromise<Unit> {
                return wrapUTSPromise(suspend w@{
                        try {
                            ...
                            uni_showToast(ShowToastOptions(title = "Network malfunction, please try again later", icon = "none"));
                        }
                });
            }
            ;
